...
_CLUBS: list[tuple[str, list[str]]] = [
    ...
    ("Локомотив", ["Lokomotiv Moscow", "FC Lokomotiv Moscow", "Lokomotiv Moskva"]),
    ("Динамо Москва", ["Dynamo Moscow", "Dinamo Moscow", "FC Dynamo Moscow"]),
    ...
    ("Крылья Советов", ["Krylya Sovetov", "Krylya Sovetov Samara"]),
