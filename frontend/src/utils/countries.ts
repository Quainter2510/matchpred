...
export const COUNTRIES: Country[] = [
  ...
  { en: "Cape Verde", ru: "Кабо-Верде", code: "cv", aliases: ["Cabo Verde", "Cape Verde Islands"] },
  { en: "Haiti", ru: "Гаити", code: "ht" },
  { en: "Curaçao", ru: "Кюрасао", code: "cw", aliases: ["Curacao"] },
  ...
  { en: "Bosnia and Herzegovina", ru: "Босния и Герцеговина", code: "ba", aliases: ["Bosnia", "Bosnia & Herzegovina"] },
